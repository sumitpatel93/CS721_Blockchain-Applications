...
/* I don't think this program have RENT bug cause the functions withdraw and withdraw_part is just sending funds
     to the customer address using the transfer function which won't call any other function or something.
   So no RENT BUG 
/*
/*

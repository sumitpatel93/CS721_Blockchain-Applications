...
/*
    The buyCore() function seems to be the one that interacts with the contract state and may be vulnerable 
    to reentrancy attacks, as it updates the rID_ state variable and calls the core() and endRound() function.
